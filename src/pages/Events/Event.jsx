...
const Event = ({ status, img, title, videos, time, description, presenter }) => {

  const { dark} = useContext(DarkThemeContext)
  return (
    <div 
      className={dark ? 'event flex flex-col justify-between items-center rounded-md relative bg-lightBlack text-white'
