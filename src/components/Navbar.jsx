...
const Navbar = () => {
  ...
  return (
    <Disclosure
      ...
      } sticky top-0 z-30  ${navbar && "shadow-lg transition duration-150"} `}
    >
      {({ open }) => (
        <>
            ...
            <div className="relative flex flex-row-reverse  h-16 items-center justify-between ">
              ...
              <div className="flex  items-center justify-center sm:items-stretch sm:justify-start">
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex items-center gap-5 text-xl flex-row-reverse">
                    <Link href="#">
                      <img src="img/logo.png" width={60} alt="logo/img" />
                    </Link>
